...
export type LandlordRentalRequestQuery = {
  page?: number
  limit?: number
  status?: RentalRequestStatus
}

export type LandlordRentalRequestList = {
  meta: PaginationMeta
...
export async function getLandlordRentalRequests({
  ...
  const response = await authenticatedApiFetch<LandlordRentalRequestList>(
